...
export default function Cover() {
    return (
        <div className="relative w-full h-100">
            ...
            <div className="flex absolute z-10 max-w-full h-full p-10 bg-white bg-opacity-70 text-purple-900 flex-row space-between" >
                <div className="flex justify-center w-full sm:w-1/2 flex-col items-center" data-aos="fade-right">
                    ...
                    {/*<button className="flex flex-row items-center text-center mt-14 text-2xl sm:text-2xl xl:text-2xl text-white p-5 cursor-pointer bg-purple-900 hover:bg-purple-600 duration-700 rounded-full font-principal">
            ...
            <div className="flex absolute z-10 text-purple-950 bottom-10 left-1/2 justify-center">
