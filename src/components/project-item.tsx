export default function ProjectItem({ image, title, description, children }: any) {
    return (
        <section className="flex flex-col bg-white hover:bg-gray-200 transition-all w-96 p-5 m-5 items-center rounded-lg cursor-pointer shadow-black duration-700 hover:shadow-2xl">
