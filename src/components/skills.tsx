    ...
    return (
        <div className='flex w-full p-16 flex-col items-center bg-purple-100'>
            ...
            <div className="flex flex-wrap w-full justify-center">
                ...
                <img className="object-contain flex w-24 sm:w-40 m-5" src="/nodejs.svg" alt="" />
                <img className="object-contain flex w-24 sm:w-40 m-5" src="/postgres.svg" alt="" />
                <img className="object-contain flex w-24 sm:w-40 m-5" src="/mongodb.svg" alt="" />
                <img className="object-contain flex w-24 sm:w-40 m-5" src="/prisma.svg" alt="" />
            </div>
            <div className="flex flex-wrap w-full justify-center">
                <img className="object-contain flex w-24 sm:w-40 m-5" src="/git.svg" alt="" />
                <img className="object-contain flex w-24 sm:w-40 m-5" src="/jest.svg" alt="" />
